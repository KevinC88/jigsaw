...
?>
  ...
  <div class="panel-heading">
    <h4 class="panel-title">Patient Info</h4>
  </div>
...
<tr>
  ...
  <?php
              ...
              <div class="panel panel-default panel-transparent">
  <div class="panel-heading">
    <h4 class="panel-title">Clozapine</h4>
  </div>
  <div class="panel-body">
							...
							<form action="inputClozapine.php" class="form-horizontal" id="contactForm" method="post" name="contactForm" role="form">
								<fieldset>
                                    ...
                                    <div class="col-xs-3">
                                    	...
                                    	<div class="form-group form-group-sm">
                                            <div class="col-xs-3">
										<label for="Clozapine">Clozapine:</label>
											<input autocomplete="off" class="form-control" id="Clozapine" name="Clozapine" placeholder="Clozapine levels" required="" type="number" step="0.1">
										</div>
                                         ...
                                         <div>        
                                    <input name="Record" class="form-control" id="Record" value="Clozapine" required="" type="hidden" >
                                 </div>
									...
									<div class="form-group form-group-sm">
                                        <div class="col-xs-3">
										<label for="addClozapineBtn"></label>
