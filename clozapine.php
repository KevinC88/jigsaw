  ...
  <?php
              ...
              <?php  } ?>
						...
						<div class="col-md-12" style='background-color: #2ba6cb;'>
							<form action="inputClozapine.php" class="form-horizontal" id="contactForm" method="post" name="contactForm" role="form">
								<fieldset>
									<legend>Clozapine Levels</legend>
									<div class="form-group">
                                      ...
                                      <div class="form-group">
                                    	...
                                    	<div class="form-group">
										<label class="col-md-3 control-label" for="Clozapine">Clozapine:</label>
										<div class="col-md-3">
											<input autocomplete="off" class="form-control input-md" id="Clozapine" name="Clozapine" placeholder="Clozapine levels" required="" type="text">
										</div>
                                         ...
                                         <div>        
                                    <input name="Record" class="form-control input-md" id="Record" value="Clozapine" required="" type="hidden" >
                                 </div>
									...
									<div class="form-group">
										<label class="col-md-4 control-label" for="addClozapineBtn"></label>
										<div class="col-md-4">
											<button class="btn btn-primary" id="submit" name="submit" type="submit">Add Clozapine Levels</button>
										</div>
									</div>
								</fieldset>
							</form>
