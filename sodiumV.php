              ...
              <?php  } ?>
						...
						<div class="col-md-12" style='background-color: #2ba6cb;'>
							<form action="inputSodiumV.php" class="form-horizontal" id="contactForm" method="post" name="contactForm" role="form">
								<fieldset>
									<legend>Sodium Valporate Levels</legend>
									<div class="form-group">
                                    	...
                                    	<div class="form-group">
										<label class="col-md-3 control-label" for="SodiumV">Lithium level:</label>
										<div class="col-md-3">
											<input autocomplete="off" class="form-control input-md" id="SodiumV" name="SodiumV" placeholder="Sodium valporate levels" required="" type="text">
										</div>
